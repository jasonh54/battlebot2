...
public final class Constants {
    ...
    public static enum TileType {NORMAL, COLLIDE, MONSTER, PORTAL}
    ...
    public static final ArrayList<Integer> portalTiles = new ArrayList<Integer>(Arrays.asList(281,282,283,284,285,339,412,413));
}
